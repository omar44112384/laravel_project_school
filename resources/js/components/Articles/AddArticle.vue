...
<form @submit.prevent="ajouterproduit">
 ...
 <div class="form-group">  Sous Catégories
 <select class="form-control" v-model="scategorie" >
  <option v-for="cs in Scategories" :key="cs.id" :value="cs.id">{{cs.nomcategorie}}</option>
 </select>
 </div>
 <div class="form-group">
...
export default {
 ...
 this.axios.post("http://localhost:8000/api/articles",pr).then(() => {
