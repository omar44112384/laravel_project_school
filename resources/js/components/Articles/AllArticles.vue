<template>
 ...
 <td><img :src="p.imageartpetitf" :alt=p.designation width="100"></td>
 <td><div >
 <img :src="p.imageartgrandf" :alt=p.designation width="70"></div></td>
 <td>
...
Scategories: [],
 ...
 this.axios.delete(`http://localhost:8000/api/articles/${id}`).then(res => {
 console.log(res)
 this.getArticles();
 })
 .catch(error => {
 ...
 getArticles(){
 this.axios.get('http://localhost:8000/api/articles').then(response => {
