...
:alt=scat.nomscategorie width="100"></td>
 ...
 <td>
<router-link :to="{name: 'editScategorie', params: { id: scat.id }}" class="btn btn-success">Modifier
 </router-link> 
 <button @click.prevent="deleteScategorie(scat.id)" class="btn btn-danger">Supprimer</button></td>
 </tr>
 </tbody>
 </table>
 </div>
